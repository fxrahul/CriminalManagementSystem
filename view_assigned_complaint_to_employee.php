...
<html lang="en">
  ...
  <body>
    <center><h1>Assigned Complaint</h1></center>
    ...
    <table class="table table-bordered table-sm table-responsive">
        ...
        <?php
            if(isset($_GET['id'])){
              ...
              $result1=mysqli_query($mysql_connect,$sql1);
              $results1 = mysqli_fetch_array($result1);
              $employeeName1 = $results1['name'];
              $employeeRole1 = $results1['role'];
              $employeeCondition = $employeeID."-".$employeeName1."-".$employeeRole1;



              $sql="SELECT * from complaint WHERE assigned_to_employee = '$employeeCondition' ";
              ...
              while($results=mysqli_fetch_array($result)){
                ...
                <td><a href="edit_complaint_by_employee.php?id=<?php echo $complaintID; ?>" class="btn btn-secondary btn-primary active" role="button" aria-pressed="true">Edit</a></td>
