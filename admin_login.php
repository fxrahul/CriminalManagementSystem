...
if(isset($_POST['userEmail']) && isset($_POST['userPassword']))
{
  ...
  // echo "<script type='text/javascript'>alert('$msg3');</script>";
	...
	if(!empty($email) && !empty($password))
	{
		...
		$query = "SELECT id FROM `admin` WHERE email='".mysqli_real_escape_string($mysql_connect, $email)."' AND password='".mysqli_real_escape_string($mysql_connect, $password_hash)."'";
